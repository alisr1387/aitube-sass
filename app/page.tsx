          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white p-6 rounded-xl border border-gray-200 hover:border-blue-500 transition-all duration-300 cursor-auto ring shadow-md ring-gray-900/5"
                >
                  <div
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {steps.map((step, index) => {
              ...
              return (
                <div
                  key={index}
                  className="text-center p-6 rounded-xl bg-white hover:shadow-lg transition-all ring shadow-md ring-gray-900/5"
                >
